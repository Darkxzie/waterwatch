  ...
  return (
    <article className="glass-panel rounded-[1.75rem] p-5 transition duration-300 hover:-translate-y-1">
      <div className="flex items-center justify-between gap-3">
        <div>
          <h3 className="font-heading text-lg font-semibold text-white">{complaint.issueType.replaceAll('_', ' ')}</h3>
      ...
      <p className="mt-4 text-sm leading-7 text-slate-200">{complaint.aiSummary || complaint.description}</p>
      <div className="mt-4">
