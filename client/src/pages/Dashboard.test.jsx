...
describe('Dashboard page', () => {
  it('shows admin login guidance when the dashboard query errors', () => {
    useAdminComplaints.mockReturnValue({ data: [], error: new Error('Forbidden'), refetch: vi.fn(), isFetching: false });
  ...
  it('renders authority queue metrics from complaint data', () => {
    useAdminComplaints.mockReturnValue({
      data: [
        { id: 'abc12345', issueType: 'LEAKAGE', address: 'Ameerpet', aiSeverity: 'CRITICAL', aiPriority: 'URGENT', status: 'OPEN' },
        { id: 'def67890', issueType: 'NO_WATER', address: 'Kukatpally', aiSeverity: 'HIGH', aiPriority: 'ROUTINE', status: 'RESOLVED' }
      ],
      error: null,
      refetch: vi.fn(),
      isFetching: false
